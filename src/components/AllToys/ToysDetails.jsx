        ...
        <div className="px-5 pb-5">
          <a href="#">
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white mb-2">
              Toy Name: {carSingle.toyname}
            </h5>
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white mb-2">
              Saller Name: {carSingle.seller}
            </h5>
            <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white mb-2">
            Available Quantity: {carSingle.availablequantity}
            </h5>
            <p className="tracking-tight text-white-700 dark:text-gray mb-2">
            <span className="text-xl font-semibold">Description:- </span> {carSingle.description}
            </p>
            <p className="tracking-tight text-gray-900 dark:text-white underline">
